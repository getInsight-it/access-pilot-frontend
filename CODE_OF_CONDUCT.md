...
Ocorrências de comportamentos abusivos, de assédio ou que sejam inaceitáveis por qualquer outro motivo poderão ser reportadas para a liderança da comunidade, responsável pela aplicação, via contato <a href="mailto:opensource@getinsight.it">opensource@getinsight.it</a>. Todas as reclamações serão revisadas e investigadas imediatamente e de maneira justa.
