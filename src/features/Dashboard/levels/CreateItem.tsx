...
export const CreateItem = () => {
  ...
  const renderSphereHierarchy = () => {
    ...
    return (
      <div className="">
        {/* <p className="text-sm text-gray-500">Hierarquia de esferas:</p> */}
        ...
        >
          ...
          <div className="w-128">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <Label className="text-lg font-bold mb-2" htmlFor="externalCode">
                  Selecionar esfera
                </Label>
                {/* Mostrar a hierarquia de esferas */}
                {renderSphereHierarchy()}
              ...
              <Button className="mr-2" onClick={() => navigate(-1)} variant="ghost">
                Voltar
              </Button>
