...
export const ExportLevelsDialog = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>{t("Exportar esferas")}</DialogTitle>
          <DialogDescription>
            {t("Defina os dados que devem compor o arquivo de exportação.")}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="app-dialog__body">
          <div className="app-dialog__surface">
            <div className="app-dialog__surface-main">
              <span className="app-dialog__surface-title">
                {t("Incluir esferas Built-in?")}
              </span>
              <span className="app-dialog__surface-description">
                {t("Esferas Built-in são ignoradas na importação.")}
              </span>
            </div>
          ...
          <div className="app-dialog__surface">
            <div className="app-dialog__surface-main">
              ...
              <span className="app-dialog__surface-description">
                {t("Exporta os itens associados a cada esfera.")}
              </span>
            </div>
