...
//   }, [currentStep, prevButtonAnimControls, steps.length])
...
//   return (
//     <div className="bg-white rounded-2xl text-black text-lg max-w-md w-full ">
//       {children}
//       {steps[currentStep]}
...
//             <span
//               key={index}
//               className={`h-12 w-12 rounded-full mx-1 z-10 flex items-center justify-center ${
...
//             initial="initial"
//             className="px-5 py-3 bg-gray-200 rounded-full transition-colors text-black"
...
//             duration: 0.3
//           }}
//           className="gap-2 px-5 py-3 bg-blue-500 transition-colors text-white rounded-full flex-grow"
//           onClick={() => setCurrentStep(prev => prev + 1)}
...
// export default function Steps({ children, steps, currentStep, onNextStep, onPrevStep, onSubmit }: Props) {
//   const prevButtonAnimControls = useAnimationControls();
//   const progressBarAnimControls = useAnimationControls();
...
//   return (
//     <div className="bg-white rounded-2xl text-black text-lg max-w-md w-full shadow-xl p-4">
//       {children}
//       {steps[currentStep]}
...
//           layout
//         >
//           {currentStep === steps.length - 1 ? "Solicitar acesso" : "Próximo"}
//         </motion.button>
//       </div>
//     </div>
//   )
...
export default function Steps({ 
  ...
  return (
    <motion.div
      ...
      layout
      className="bg-white rounded-xl text-black max-w-md w-full "
    >
      {children}
      {steps[currentStep]}
