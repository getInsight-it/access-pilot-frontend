...
//       className={`flex origin-top-left items-center gap-1 rounded-full border bg-white px-1.5 py-0.5 text-sm transition-all ${selected ? "-rotate-3 border-indigo-600 text-indigo-600" : "border-zinc-900 dark:text-black hover:bg-zinc-200"}`}
//     >
//       <Check /> {children}
//     </button>
//   </div>
...
//         onClick={() => setSelected(index)}
//         className={`
//                     flex origin-top-left items-center gap-1 rounded-full border px-1.5 py-0.5 text-sm transition-all ${getButtonStyle()}
//                     ${selected ? "-rotate-3 border-indigo-600 text-indigo-600" : "border-zinc-900 dark:text-black"}`}
//       >
//         <Check /> {children}
//       </button>
