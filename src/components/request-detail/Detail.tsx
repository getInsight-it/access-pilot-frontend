...
//           <div className="grid grid-flow-row-dense grid-cols-1 lg:grid-cols-10 xl:grid-cols-9 gap-8">
...
//             <div className="hidden col-span-2 relative border-t mt-8 w-full">
...
//                       <div className="ring-2 ring-primary p-6 grid items-center min-h-[160px] h-auto transition-all rounded-[var(--card-border-radius)] ">
...
//               <div className="relative border-t mt-6 w-full">
//                 <div className="absolute  text-white w-40 h-40 left-[50%] -ml-20 top-[50%] mt-10 p-4">
//                   <p className="text-sm mb-1 font-semibold">
//                     {data?.requestingUser.firstName}
//                   </p>
            ...
            <div className="col-span-1 h-fit">
              <Card className="sm:h-[400px]">
                <div className="w-full h-[400px] relative">
                  ...
                  {/* <img className="absolute top-0 right-20 w-40 mx-auto" src="/img/cracha.svg" /> */}
