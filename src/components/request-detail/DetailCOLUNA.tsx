...
import { Calendar, Check, Clock, Copy, Download, File, MonitorIcon as MonitorCog, Pencil, User } from 'lucide-react';
...
export const Detail = ({
  ...
  return (
      <>
        <div className="relative max-w-[1296px] mt-2">
          
          <div className="grid grid-flow-row-dense grid-cols-1 lg:grid-cols-9 gap-8">

            <div className="hidden xl:block lg:col-span-2 w-full">
              <div className="flex items-center">
                <div className={cn("w-8 h-8 rounded-full flex items-center justify-center bg-primary text-primary-foreground")}>
                  1
                </div>
                <p className="font-bold ml-3">Status da solicitação:</p>
              </div>
            </div>
          ...
          <div className="grid grid-flow-row-dense grid-cols-1 lg:grid-cols-9 gap-8 mt-6">
            ...
            <div className="lg:col-span-2 w-full">
              <div className="flex items-center">
                ...
                <p className="font-bold ml-3">Sistema e papel:</p>
              </div>
            </div>
                ...
                <div className="flex gap-6">
                  <div className="w-full ">
                    ...
                    <CardShine>
                      ...
                      <div className="border-2 border-primary p-6 grid items-center h-auto transition-all rounded-[var(--card-border-radius)] ">
          ...
          <div className="grid grid-flow-row-dense grid-cols-1 lg:grid-cols-9 gap-8 mt-6">
            ...
            {/* <div className="lg:col-span-2 w-full">
              <div className="">
                <p className="font-bold mb-3">Motivo do acesso:</p>
              </div>
            </div> */}
            ...
            <div className="lg:col-span-2 w-full">
              <div className="flex items-center">
                ...
                <p className="font-bold ml-3">Motivo do acesso:</p>
              </div>
            </div>
            ...
            <div className="col-span-2 w-full">
              ...
              <div className="hidden relative border-t w-full">
                <div className="absolute  text-white w-40 h-40 left-[50%] -ml-20 top-[50%] mt-10 p-4">
                  <p className="text-sm mb-1 font-semibold">
                    {data?.requestingUser.firstName}
                  </p>
