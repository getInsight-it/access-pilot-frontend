...
export default function Example() {
  ...
  return (
    <div className="relative bg-gray-50">
      ...
      <main>
        <div className="mx-auto w-full pt-16 pb-20 text-center">
          <div className="px-0">
            <h1 className="tracking-tight font-extrabold text-gray-900 text-xl ">
              ...
              <img
                ...
                alt="Imagem do sistema"
              />
              <span className="block text-indigo-600 mt-2">CRM</span>
            </h1>
            {/* <p className="mt-3 max-w-md mx-auto text-gray-500 text-xl">
              Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo.
            </p> */}
            <div className="mt-10 flex flex-col justify-center px-3">
              <div className=" rounded-md shadow mt-0">
                <a
                  href="#"
                  className="w-full flex items-center justify-center px-4 py-1 border border-transparent text-lg font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700"
                >
                  Entrar
                </a>
              </div>
              <div className="rounded-md shadow mt-2">
                <a
                  href="#"
                  className="w-full flex items-center justify-center px-4 py-1 border border-transparent text-lg font-medium rounded-md text-indigo-600 bg-white hover:bg-gray-50"
                >
                  Cadastrar
                </a>
              </div>
