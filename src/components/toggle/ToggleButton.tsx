...
const ToggleButton = () => {
  ...
  return (
    <div
      className={`pointer-events-auto mt-8 rounded-full w-full px-[2px] h-[60px] flex items-center  transition-colors ${
        mode === "dark" ? "bg-yellow-200 text-yellow-800" : "bg-green-200 text-green-800"
      }`}
    >
